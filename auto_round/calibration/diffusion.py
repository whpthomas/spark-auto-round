...
class DiffusionCalibrator(LLMCalibrator):
    ...
    def calib(self, nsamples: int, bs: int) -> None:
        ...
        NOTE: Diffusion support is disabled because auto_round.compressors.diffusion
        module was removed for GB10/CUDA focus. To re-enable, restore the diffusion
        module and uncomment this code.
        """
        raise NotImplementedError(
            "Diffusion model quantization is not supported in this build. "
            "The diffusion module was removed for GB10/CUDA focus."
        )
