...
def update_fused_layer_global_scales(
    ...
    """
    Update global scales for fused layers.
...
def update_block_global_scale_if_needed(block, data_type, group_size):
    """Update global scales for fused layers if needed.

    NVFP4 quantization is not supported in this build, so this is a no-op.
    """
    pass
