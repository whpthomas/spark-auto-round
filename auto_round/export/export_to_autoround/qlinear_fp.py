...
def _lazy_mxfp_imports():
    # Lazy imports for MXFP/NVFP - only available when those modules exist.
    ...
    return FP32_EXPONENT_BIAS, FP32_MIN_NORMAL, cast_to_fp4, get_reciprocal
...
class QuantLinear(nn.Module):
    ...
    def pack(self, linear, scales, zeros=None, g_idx=None, global_scale=None, input_global_scale=None, device=None):
        ...
        if self.is_nv:
            ...
            _, _, cast_to_fp4, get_reciprocal = _lazy_mxfp_imports()
