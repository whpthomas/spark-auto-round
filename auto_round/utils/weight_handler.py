...
# ----------------------------------------------------------------------------
# ----------------------------------------------------------------------------
# NOTE: MXFP4, MXFP8, and NVFP4 handlers are disabled because they require
# auto_round_extension.vllm_ext which has been removed for GB10/CUDA focus.
# To re-enable, restore vllm_ext and uncomment these handlers.
# ----------------------------------------------------------------------------

# MXFP4 Handler - DISABLED (requires vllm_ext)
# @register_weight_type_handler(ModuleWeightType.MXFP4)
# class MXFP4Handler(WeightTypeHandler):
#     ... (see git history for full implementation)

# MXFP8 Handler - DISABLED (requires vllm_ext)
# @register_weight_type_handler(ModuleWeightType.MXFP8)
# class MXFP8Handler(WeightTypeHandler):
#     ... (see git history for full implementation)

# NVFP4 Handler - DISABLED (requires vllm_ext)
